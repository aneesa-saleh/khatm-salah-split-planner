import type { QuranData } from "../src/typing/quranData";

const QURAN_DATA: QuranData = {
    ayahs:
    {
        count: 6236
    },
    ...
    juzs:
    {
        ...
        references: [
            // Juz 1
            {
                start: { surah: 1, ayah: 1, page: 1 },
                end: { surah: 2, ayah: 141, page: 21 }
            },

            // Juz 2
            {
                start: { surah: 2, ayah: 142, page: 22 },
                end: { surah: 2, ayah: 252, page: 41 }
            },

            // Juz 3
            {
                start: { surah: 2, ayah: 253, page: 42 },
                end: { surah: 3, ayah: 92, page: 61 }
            },

            // Juz 4
            {
                start: { surah: 3, ayah: 93, page: 62 },
                end: { surah: 4, ayah: 23, page: 81 }
            },

            // Juz 5
            {
                start: { surah: 4, ayah: 24, page: 82 },
                end: { surah: 4, ayah: 147, page: 101 }
            },

            // Juz 6
            {
                start: { surah: 4, ayah: 148, page: 102 },
                end: { surah: 5, ayah: 81, page: 121 }
            },

            // Juz 7
            {
                start: { surah: 5, ayah: 82, page: 122 },
                end: { surah: 6, ayah: 110, page: 141 }
            },

            // Juz 8
            {
                start: { surah: 6, ayah: 111, page: 142 },
                end: { surah: 7, ayah: 87, page: 161 }
            },

            // Juz 9
            {
                start: { surah: 7, ayah: 88, page: 162 },
                end: { surah: 8, ayah: 40, page: 181 }
            },

            // Juz 10
            {
                start: { surah: 8, ayah: 41, page: 182 },
                end: { surah: 9, ayah: 92, page: 201 }
            },

            // Juz 11
            {
                start: { surah: 9, ayah: 93, page: 202 },
                end: { surah: 11, ayah: 5, page: 221 }
            },

            // Juz 12
            {
                start: { surah: 11, ayah: 6, page: 222 },
                end: { surah: 12, ayah: 52, page: 241 }
            },

            // Juz 13
            {
                start: { surah: 12, ayah: 53, page: 242 },
                end: { surah: 14, ayah: 52, page: 261 }
            },

            // Juz 14
            {
                start: { surah: 15, ayah: 1, page: 262 },
                end: { surah: 16, ayah: 128, page: 281 }
            },

            // Juz 15
            {
                start: { surah: 17, ayah: 1, page: 282 },
                end: { surah: 18, ayah: 74, page: 301 }
            },

            // Juz 16
            {
                start: { surah: 18, ayah: 75, page: 302 },
                end: { surah: 20, ayah: 135, page: 321 }
            },

            // Juz 17
            {
                start: { surah: 21, ayah: 1, page: 322 },
                end: { surah: 22, ayah: 78, page: 341 }
            },

            // Juz 18
            {
                start: { surah: 23, ayah: 1, page: 342 },
                end: { surah: 25, ayah: 20, page: 361 }
            },

            // Juz 19
            {
                start: { surah: 25, ayah: 21, page: 362 },
                end: { surah: 27, ayah: 55, page: 381 }
            },

            // Juz 20
            {
                start: { surah: 27, ayah: 56, page: 382 },
                end: { surah: 29, ayah: 45, page: 401 }
            },

            // Juz 21
            {
                start: { surah: 29, ayah: 46, page: 402 },
                end: { surah: 33, ayah: 30, page: 421 }
            },

            // Juz 22
            {
                start: { surah: 33, ayah: 31, page: 422 },
                end: { surah: 36, ayah: 27, page: 441 }
            },

            // Juz 23
            {
                start: { surah: 36, ayah: 28, page: 442 },
                end: { surah: 39, ayah: 31, page: 461 }
            },

            // Juz 24
            {
                start: { surah: 39, ayah: 32, page: 462 },
                end: { surah: 41, ayah: 46, page: 481 }
            },

            // Juz 25
            {
                start: { surah: 41, ayah: 47, page: 482 },
                end: { surah: 45, ayah: 37, page: 501 }
            },

            // Juz 26
            {
                start: { surah: 46, ayah: 1, page: 502 },
                end: { surah: 51, ayah: 30, page: 521 }
            },

            // Juz 27
            {
                start: { surah: 51, ayah: 31, page: 522 },
                end: { surah: 57, ayah: 29, page: 541 }
            },

            // Juz 28
            {
                start: { surah: 58, ayah: 1, page: 542 },
                end: { surah: 66, ayah: 12, page: 561 }
            },

            // Juz 29
            {
                start: { surah: 67, ayah: 1, page: 562 },
                end: { surah: 77, ayah: 50, page: 581 }
            },

            // Juz 30
            {
                start: { surah: 78, ayah: 1, page: 582 },
                end: { surah: 114, ayah: 6, page: 604 }
            }
        ]
    }
}
...
export const LAST_PAGE_NUMBER = 604;

export const FIRST_JUZ_NUMBER = 1;
export const LAST_JUZ_NUMBER = 30;

export const FIRST_VERSE_NUMBER = 1;
